    ...
    internal class OpenAiService
    {
        ...
        public OpenAiService()
        {
            ...
            _behaviorRules = new Dictionary<string, string> {
                ...
                {"rule8", "8. In conflict between \"Emoji circle on the start of response\" and \"true/false/null on the start of response\" ALWAYS sets first true/false/null. true/false/null is priority above circle emojis. In this cases Circle emojis go SECOND, right after true/false/null but separated with white space." }
